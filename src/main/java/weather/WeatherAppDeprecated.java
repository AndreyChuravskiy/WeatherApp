...
public class WeatherAppDeprecated extends Application {
    ...
    private void updateEvent() {
        WeatherState weatherState = updater.fetchWeatherData(true);
        System.out.println(weatherState.getForecast().getParts().size());
